			...
			<div class="wide_container_3 carousel-full-width">
				<div class="tabs colored_tabs">
                	<ul class="tab-links col-lg-12 col-md-12">
						...
						<li class="col-xs-3"><a href="#tab_c">Pago y consulta de cuentas</a></li>
					...
					<div class="tab-content">
						<div id="tab1" class="tab active">
							...
							<div id="owl-demo-2" class="owl-carousel owl-theme">
								<div class="item">
									<div class="image" style="background: url(<?php echo base_url().'images/imagen_rentas/'.$proyecto[0]->COD_INM.'/type/00000002/size/big'///size/big'?>) center"></div>
								</div>
								<div class="item">
									<div class="image" style="background: url(<?php echo base_url().'images/imagen_rentas/'.$proyecto[0]->COD_INM.'/type/00000003/size/big'///size/big'?>) center"></div>
								</div>
								<div class="item">
									<div class="image" style="background: url(<?php echo base_url().'images/imagen_rentas/'.$proyecto[0]->COD_INM.'/type/00000004/size/big'///size/big'?>) center"></div>
								</div>
							</div>
							<!-- End Owl carousel -->
				...
				<div class="container" style="padding-top: 35px;">
					<div class="row">
						<aside class="pr-summary col-md-4 col-xs-12">
							...
							<form action="agent_profile.html">
								<div class="col-lg-7 col-md-6 col-sm-3 col-xs-6 hl-bl">
									<h2>$<?php echo number_format($proyecto[0]->VAL_OFE)?></h2>
									<h5 class="team-color">Arriendos</h5>
								</div>
									...
									<div class="col-md-12 col-sm-6 col-xs-12">
										<div class="row">
											<div class="col-lg-5 col-md-6 col-xs-6 cat-img">
												...
												<p style="white-space:nowrap">Ciudad: <?php
													if(strtolower(trim($proyecto->DES_CIU))=='arrendamientos'){
													echo 'MEDELLÍN';	
														}else{
													$xpl = explode(' ', trim($proyecto[0]->DES_CIU));
													echo strtoupper(trim($xpl[1]));
															}
												?></p>
											</div>
											<div class="col-lg-7 col-md-6 col-xs-6 cat-img cat-img">
												<p>Zona:  <?php echo $proyecto[0]->SEC_INM?></p>
											</div>
										</div>
										<hr>
										<div class="row">
											<div class="col-xs-12">
												<div class="row">
													<div class="col-lg-5 col-md-6 col-xs-6 cat-img">
														<p class="info_line">Mt2: 
 							<?php echo $proyecto[0]->ARE_CON?> <span class="rank">2</span></p>
													</div>
													<div class="col-lg-7 col-md-6 col-xs-6 cat-img">
														<p class="info_line">Tipo: <?php echo $proyecto[0]->DES_TIP?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-xs-12">
						...
						<div class="pr-info col-md-8 col-xs-12 box_info">
                            ...
                            <img style="width: 400px !important;display: block; margin: auto;" src="<?php echo base_url().'images/imagen_rentas/'.$proyecto[0]->COD_INM.'/type/home/size/big'///size/big'?>" class="banner_usa_arr" />
                            <br><br>
							<h5><i class="fa fa-info-circle" aria-hidden="true"></i> C&Oacute;DIGO: <?=$proyecto[0]->COD_INM?></h5>
												...
												$main_counter =0;
												 foreach($galery_mod as $img){?>
                                                    <div class="col-md-2 col-xs-6 cust-pad">
                                                        <div class="pr-img priority_img"  data-imagen="<?php echo base_url('images/imagen_rentas/'.$img->COD_INM.'/type/'.$img->COD_MOV.'/size/big');?>">
<?php $main_counter++?>
...
<?php }?>
						...
						<div id="tab_c" class="tab">
                            ...
                            <div class="wide-2 clearfix">
                                ...
                                <div class="col-md-8">
                                        <form  target="_blank"  id="form-submit" method="get" class="form-submit clearfix" action="http://www.emepropiedadraiz.com.co/paco/owa/C_Cartera_Usuario_Internet.FacturasPago?V_CodCon=001942&V_CodSoc=001942">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <label>Identificación:</label>
                                                    <input id="input-name" name="F_NitCon" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <label>Contraseña:</label>
                                                    <input  type="password" name="F_Clave" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="submit">
                                                <span class="ffs-bs">
                                                
                                                <button type="submit" class="btn btn-large btn-primary" style="color:#fff;">Ingresar</button></span>
                                            </div>
                                        </form>
                                        <a class="bt_link" href="https://www.paco.com.co/paco/owa/C_Cartera_Usuario_Internet.RecuperarClave?V_CodCon=001942&V_CodSoc=001942
"  target="_blank">Olvidé mi contraseña</a>
...
" target="_blank">Crear clave</a>
                        ...
                        <?php foreach($documentos as $doc){?>
                                                                               <a class="doc_link clearfix" target="_blank" href="<?php echo base_url("arrendamientos/download_doc/".$doc->CODIGO);?>">
		...
		<div class="overlay overlay-hugeinc">
			...
			<nav>
				...
				<div class="owl-carousel owl-theme carousel-full-width owl-demo-3">
                    ...
                    <div class="item to_process2" data-imagen="<?php echo base_url('images/imagen_rentas/'.$img->COD_INM.'/type/'.$img->COD_MOV.'/size/big');?>"></div> <?php }?>
