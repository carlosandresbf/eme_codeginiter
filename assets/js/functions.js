...
/* ----------------------------------------------*/
var val_c=true;
if($("#cant_of_banners").val()==1){ var val_c=false;}
...
$(".clos").on("click",function(){
    $(".buscarDist").hide("fade");
    $(".formPQR").hide("fade");
});
$(".buscart").on("click",function(){
    $(".buscarDist").show("fade");
});
...
$(".openm").on("click",function(){
    $(".navigat").attr('style','display: block !important');
    $(".closem").show("fade");
     $(".openm").hide("fade");
});
$(".enviarpqr").on("click",function(){
    $(".formPQR").show("fade");
});
