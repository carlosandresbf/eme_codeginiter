					...
					<div class="tab-content" style="height:auto">
						<div id="tab_a" class="tab active">
	                       <div class="container">
                                <div class="wide_container_2">
                                        <div class="tabs">
                                        <form method="get" id="frmSearch" action="<?=base_url("arrendamientos")?>">
                                            <header class="col-md-12 col-xs-12 no-pad">
                                                ...
                                                <div class="col-sm-2 col-xs-2">
													...
													<?php  foreach($filtro1 as $item){?>
													<option><?php
													if(strtolower(trim($item->IROW))=='arrendamientos'){
													echo 'MEDELLÍN';	
														}else{
													$xpl = explode(' ', trim($item->IROW));
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8 col-xs-8 top-mrg">
                                                            <div class="internal-container features">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label>Ba&ntilde;os Alcobas</label>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label>Ba&ntilde;os Familiares</label>
                                                                    <select name="banosfamiliares" class="form-control">
                                                                        <option>0</option>
                                                                        <option>1</option>
                                                                        <option>2</option>
                                                                        <option>3</option>
						...
						if($nnt==1){?><div class="row"><?php }?> 
                                                                    ...
                                                                    <div class="col-md-3 col-sm-3 col-xs-6 prop">
                                                                        <div class="item_house">
                                                                            <a href="<?php echo base_url()?>arrendamientos/show/<?php echo url_encode($item->COD_INM.'_'.$item->DES_TIP)?>" class="image_house img-info  priority_img" data-imagen="<?php echo base_url().'images/imagen_rentas/'.$item->COD_INM.'/type/home/size/big'?>" >
                                                                                <div class="brand"><?php /*?><img src="assets/img/011.jpg"><?php */?></div>
                                                                                <div class="btn_ver">Ver detalle</div>
                                                                            </a>
                                                                            <div class="title_house">
                                                                                <!-- Las Palmas<br> --><span><?=$item->DES_TIP?></span><br />
                                                                                <div style="font-weight:bold" class="min_des_barrio"><?=$item->SEC_INM?></div>
                                                                            </div>
                                                                            <div class="info_house">
                                                                             <div class="item_info_house clearfix">
                                                                                    <div class="left">Área</div><div class="right"><?=$item->ARE_CON?> mt<sup>2</sup></div>
                                                                                </div>
                                                                                <div class="item_info_house clearfix">
                                                                                    <div class="left">Ciudad</div><div class="right min_des_barrio"><?php
													if(strtolower(trim($item->DES_CIU))=='arrendamientos'){
													echo 'MEDELLÍN';	
														}else{
													$xpl = explode(' ', trim($item->DES_CIU));
													echo strtoupper(trim($xpl[1]));
															}
												?></div>
                                                                                </div>
                                                                                ...
                                                                                <div class="item_info_house clearfix">
                                                                                    <div class="left">Barrio</div><div class="right min_des_barrio"><?=$item->DES_BAR?></div>
                                                                                </div>  
                                                                            </div>
